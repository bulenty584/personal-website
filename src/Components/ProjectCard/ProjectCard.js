            ...
            <div className="space-y-2 pb-8 pt-6 md:space-y-5">
                    {clicked ? (
                        <div className="flex flex-col items-center justify-center">
                            ...
                            onClick={handleClick}
                            >
                            <div className= "text-warm_white h-96 animate-fadeIn text-center lg:text-3xl md:text-2xl font-semibold"> {description} </div>
                            </div>
                        </div>
                    ) : (
                        <div 
                    ...
                    <p className="pt-3 text-center lg:text-2xl md:text-2xl font-semibold text-warm_white">{title}</p>
                </div>
            </div>
        </>
        )
