    ...
    <div id="exp">
      <div className="flex items-center justify-center mt-12">
        ...
        >
          ...
          >
          <h2 className="mt-8 mb-8 text-center lg:text-2xl font-bold l3 text-warm_white md:text-1xl">
            Software Consultant at Kommu Inc.
          </h2>
          <p className="lg:text-1xl l0 text-gray-500 dark:text-gray-400 text-warm_white">
          ...
          hover:scale-106 transition-duration-300 w-1/4"
          >
          <h2 className="mt-8 mb-8 text-center lg:text-2xl md:text-xl font-bold l3 text-warm_white">
            AI/ML Solutions Intern at Tailwind Wealth Management, LLC
          </h2>
          <p className="lg:text-xl l0 text-gray-500 dark:text-gray-400 text-warm_white">
            June 2023 - August 2023
          </p>
          </div>
          <p className="mt-10 text-left m-0 w-1/2 lg:text-2xl md:text-lg l0 text-gray-500 dark:text-gray-400 text-warm_white">
